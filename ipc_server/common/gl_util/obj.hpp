...
public:
    ...
    ObjScene(const std::string& obj_dir, const std::string& obj_filename, bool SR) {
        ...
        std::cout<<"loading obj: "<<obj_file<<std::endl;
        
        //pyh since scene reconstruction does not have material modify the load function
        bool success = tinyobj::LoadObj(&attrib, &shapes, nullptr, &warn, &err, obj_file.c_str(), obj_dir_term.c_str());
