...
//        g_object_set(G_OBJECT(identity), "signal-handoffs", TRUE, nullptr);
        ...
        gst_bin_add_many(GST_BIN(_pipeline_img0), _appsrc_img0, decoder_img0, glcolorconvert_0, caps_filter_0, _appsink_img0, nullptr);
        gst_bin_add_many(GST_BIN(_pipeline_img1), _appsrc_img1, decoder_img1, glcolorconvert_1, caps_filter_1, _appsink_img1, nullptr);
    ...
    void video_decoder::enqueue(std::vector<char>&& img0, std::string& img1) {
