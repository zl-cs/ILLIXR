...
public:
    ...
    {
        plugin::start();
        _m_thread = std::thread([this] { thread_main(); });
    }
...
protected:
     ...
     */
    virtual auto _p_should_skip() -> skip_option { return skip_option::run; }
     ...
     */
    auto should_terminate() -> bool { return _m_terminate.load(); }
