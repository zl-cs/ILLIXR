...
public:
	...
	timewarp_gl(std::string name_, phonebook* pb_)
		...
		, _m_vsync_estimate{sb->publish<time_point>("vsync_estimate")}
...
private:
	...
	std::unique_ptr<writer<time_point>> _m_vsync_estimate;
...
public:
	...
	virtual void _p_one_iteration() override {
		...
		_m_vsync_estimate->put(new time_point(GetNextSwapTimeEstimate()));
