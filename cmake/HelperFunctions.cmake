...
macro(add_test_coverage name)
    ...
    if(ENABLE_COVERAGE)
        ...
        list(APPEND COVERAGE_DEPENDENCIES ${name})
    endif()
endmacro()
...
macro(add_test_coverage_plugin name)
    ...
    if(ENABLE_COVERAGE)
        append_coverage_compiler_flags_to_target(test_${name})
        append_coverage_compiler_flags_to_target(${name})
        list(APPEND COVERAGE_DEPENDENCIES test_${name})
        set(COVERAGE_DEPENDENCIES ${COVERAGE_DEPENDENCIES} PARENT_SCOPE)
    endif()
endmacro()